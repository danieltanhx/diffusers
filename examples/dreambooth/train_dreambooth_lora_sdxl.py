...
def import_model_class_from_model_name_or_path(
    pretrained_model_name_or_path: str, revision: str,variant:str, subfolder: str = "text_encoder"
):
...
def main(args):
    if ',' in args.resolution:
        ...
        resolution=tuple([int(i) for i in resolution])
    else:
        resolution=int(resolution)
    print('resolution is %s'%str(resolution))
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    if global_step % args.checkpointing_steps == 0:
                        ...
                        os.system('rclone copy %s  remote:%s'%(save_path,save_path))
